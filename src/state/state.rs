...
use crate::state::{Key, Layouts, Leds, Mods, Serialize, Update};
use crate::{Keycode, Keymap};
use ffi::*;
...
impl State {
    ...
    pub fn keymap(&self) -> Keymap {
        unsafe { Keymap::from_ptr(xkb_state_get_keymap(self.0)) }
    }
...
impl Clone for State {
    #[inline]
    fn clone(&self) -> Self {
        unsafe { State(xkb_state_ref(self.0)) }
    }
}
